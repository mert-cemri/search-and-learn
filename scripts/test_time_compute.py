...
from sal.search import beam_search, best_of_n, dvts, speculative_beam_search, speculative_importance_search, speculative_beam_search_merged_models
...
def main():
    ...
    if config.approach == "speculative_beam_search" or config.approach =="speculative_importance_search":
        ...
        dataset = dataset.map(
            ...
            batched=True,
            batch_size=config.search_batch_size,
            fn_kwargs={"config": config, "llm": llm, "merged_model": merged_model_reward, "tokenizer": tokenizer},
